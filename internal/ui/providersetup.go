...
func detectProvider(path string, cfg *wireguard.Config) string {
	...
	// Handle comma-separated DNS or DNS with spaces
	...
	// DNS/endpoint/content are absent. Providers consistently assign
	// interface IPs from distinctive sub-ranges of RFC1918 space.
	addr := cfg.Address
	switch {
