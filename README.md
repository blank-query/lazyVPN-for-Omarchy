...
**Secure Deletion:**
You will be prompted to securely shred credential files, config files, and sanitize shell history. **The uninstaller uses interactive secure deletion to ensure all files are irrecoverably destroyed.**
